    ...
    <div className="min-h-[calc(100vh-8rem)] flex items-center justify-center bg-gradient-to-br from-background via-background to-muted/20 p-4 py-12">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-balance">{t("auth.login.subtitle")}</h1>
          <p className="mt-2 text-sm sm:text-base text-muted-foreground">{t("auth.login.description")}</p>
        </div>
        <LoginForm />
      </div>
    </div>
